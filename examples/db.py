...
scores = osu.scores_db.get_best_scores_before(datetime.datetime(year=2019, month=3, day=1, tzinfo=timezone.utc), names=["flubb 4", "ito", "biglizard"], ranked_only=False)
for x, score in enumerate(scores[:10]):
